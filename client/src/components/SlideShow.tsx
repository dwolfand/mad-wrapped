...
const isLocationSupported = (locationName: string): boolean => {
  const normalized = normalizeLocationName(locationName);
  return SUPPORTED_LOCATIONS.some(
    (loc) => normalizeLocationName(loc) === normalized
  );
};
...
const SlideShow = ({ stats, studioId }: SlideShowProps) => {
  ...
  // Check if user's main location is supported
  const locationSupported = isLocationSupported(stats.favoriteLocation.name);
  ...
  // If location is not supported, show a simple message
    ...
    const slides = [
      {
        ...
        content: (
          <>
            ...
            >
              Your location's 2025 Wrapped is not available at this time.
            </p>
            <p style={{ marginTop: "1rem", fontSize: "1rem", opacity: 0.8 }}>
              Keep crushing it at MADabolic! 💪
            </p>
          </>
        ),
      },
      ...
      <div className="slideshow">
        <div className="slide-header">
          ...
          <h1 className="year-title">
            {stats.firstName}'s 2025 Year in Review
          </h1>
        </div>
        <motion.div
